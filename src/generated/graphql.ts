	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'feedEvents' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'rsvpEvent' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{
...
} as unknown as DocumentNode<FeedEventsQuery, FeedEventsQueryVariables>;
