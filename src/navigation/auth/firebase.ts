...
const GoogleFirebase = () =>
	useIdTokenAuthRequest({
		clientId:
			'407776071745-k7qtb73u9u3uda0utpj005fhv7hj1h0r.apps.googleusercontent.com', // prod-android
		// '407776071745-q2dncci7kv03onfhhoc0to6nlkjb5858.apps.googleusercontent.com', // web
	});
